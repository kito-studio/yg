...
const JA: Record<string, string> = {
  ...
  weight_dialog_col_weight: "ウエイト",
  weight_dialog_total_label: "入力合計",
  stage_tab_basic: "基本",
  stage_tab_image: "画像",
  ...
  task_image_label: "タスク画像",
  map_image_label: "マップ画像",
  image_filter_hue_label: "色相回転",
  image_filter_brightness_label: "明度",
  image_filter_contrast_label: "コントラスト",
  ...
  stage_page_title: "ステージ画面",
  stage_page_heading: "ステージ画面",
  map_page_title: "マップ画面",
  map_page_heading: "マップ画面",
  back_to_top: "トップへ戻る",
  back_to_stage: "ステージへ戻る",
  edit_mode_label: "編集",
  add_map: "+ マップ追加",
  add_task: "+ タスク追加",
  selected_stage: "選択ステージ",
  selected_map: "選択マップ",
  map_list: "マップ一覧",
  task_list: "タスク一覧",
  prev: "◀ 前",
...
const EN: Record<string, string> = {
  ...
  add_task_aria: "Add task",
  weight_adjust_aria: "Adjust weights",
  ...
  task_settings_title: "Task Settings",
  task_progress_title: "Progress Input",
  stage_settings_sub: "Edit stage status and basic information.",
  task_settings_sub: "Edit task status and basic information.",
  ...
  weight_dialog_col_weight: "Weight",
  weight_dialog_total_label: "Input Total",
  ...
  task_image_label: "Task Image",
  map_image_label: "Map Image",
  image_filter_hue_label: "Hue Rotate",
  image_filter_brightness_label: "Brightness",
  image_filter_contrast_label: "Contrast",
  ...
  cancel: "Cancel",
  save: "Save",
  task_progress_update: "Update Progress!",
  ...
  stage_page_title: "Stage Page",
  stage_page_heading: "Stage Page",
  map_page_title: "Map Page",
  map_page_heading: "Map Page",
  ...
  open_map: "Open",
  edit: "Edit",
  no_stage: "No stage available",
  no_map: "No map available",
  no_task: "No task available",
  map_edit_title: "Map Edit",
